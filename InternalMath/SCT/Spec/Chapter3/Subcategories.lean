...
extend_type_theory SCT where
  ...
  lf_def subcategory : (C : SCat) ⇒ (W : MorphismCollection C) ⇒
    ...
    fun C W ids comp => π₁ (subcategoryPackage C W ids comp)
  ...
  lf_def subcategoryIncl : (C : SCat) ⇒ (W : MorphismCollection C) ⇒
    ...
    fun C W ids comp => π₁ (π₂ (subcategoryPackage C W ids comp))
  ...
  lf_def subcategoryInclPreserves : (C : SCat) ⇒ (W : MorphismCollection C) ⇒
    ...
    fun C W ids comp => π₁ (π₂ (π₂ (subcategoryPackage C W ids comp)))
namespace SCT
