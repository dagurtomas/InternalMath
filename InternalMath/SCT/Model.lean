...
def sctModel.{u} : SCTModel.{u} where
  ...
  coreProductEquiv := sorry
  corePullbackEquiv := sorry
  simplex2CoreEndpointEquiv := sorry
  ...
  catInternalInitial := sorry
  catInternalProduct := sorry
  catInternalCoproduct := sorry
  catInternalPullback := sorry
  catInternalFunctorCategory := sorry
  ...
  animaSmall := sorry
  geometricRealizationSmall := sorry
  fiberwiseLocalizationTotal := sorry
  fiberwiseLocalizationProjection := sorry
  fiberwiseLocalizationFibration := sorry
  fiberwiseLocalizationCocartesian := sorry
  cocartesianFibrationsOverCat := sorry
  straighteningUnstraighteningEquiv := sorry
  universalComposablePairCat := sorry
  universalComposablePairProjection := sorry
